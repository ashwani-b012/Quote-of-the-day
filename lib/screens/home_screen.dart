...
import 'dart:math';
import 'package:quote_of_the_day/data/sample_data.dart';
import 'package:quote_of_the_day/models/quote.dart';
import 'package:quote_of_the_day/screens/favorite_quotes_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 88, 25, 136),
      ),
      body: Padding(
